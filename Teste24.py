...
class Window(Frame):
    ...
    def showImagemInicial(self):
        ...
        foto =PhotoImage(file="LogoInre.PNG")
    ...
    def getDate(self):
        ...
        self.showTime = strftime("%d-%m-%Y %H:%M:%S", localtime())

        self.showTime_2 = strftime("%d-%m-%Y",localtime())

        self.date_1 = datetime.datetime.strptime(self.showTime_2, "%d-%m-%Y")

        self.end_date = self.date_1 + datetime.timedelta(days=10)
    ...
    def showCadastro(self):
        ...
        Label(self.master,text="{0}".format(self.showTime)).grid(row=4,column=2)
    ...
    def saveCliente(self):
        ...
        data["Clientes"].append({"Code":str(self.code),"Data do contato inicial":str(self.showTime),"Nome": str(self.nome.real),"RG": str(self.rg.real),"CPF": str(self.cpf.real),"E-mail": str(self.mail.real),\
    ...
    def savePrestador(self):
        ...
        data["Prestadores"].append({"Code":str(self.codePrestador),"Data do contato inicial":str(self.showTime),"Nome": str(self.empresa.real),"Servico prestado": str(self.servico_prestado.real),"CNPJ": str(self.cnpj.real),"E-mail": str(self.email.real),\
    ...
    def showPrePrestador(self):
        ...
        Button(self.master,text="Verificar se existe no registro de prestadores",command=self.verifyPrestador,pady=30).grid()
    ...
    def searchPrestador(self):
        ...
        for prestador in data["Prestadores"]:
            if prestador['Code'] == self.prestador.real:
                ...
                Label(self.master,text="Prestador registrado!",font=fonteC,pady=20).grid(row=5,column=0)
        ...
        if self.true_false[0] == "0":
            ...
            Label(self.master,text="Prestador não encontrado",font=fonteC).grid(row=5,column=0)
