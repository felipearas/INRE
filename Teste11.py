...
class Window(Frame):
    ...
    def createOrcamento(self):
        ...
        Radiobutton(self.scroll_2,text="Com movéis grandes",padx = 20,pady=20,variable=self.v,value=1).grid(row=0,column=2)
        Radiobutton(self.scroll_2,text="Sem movéis grandes",padx = 20,pady=20,variable=self.v,value=2).grid(row=0,column=3)
        ...
        C1 = Checkbutton(self.scroll_2, text = "Unibes", variable = self.CheckVar1, \
                 onvalue = 1, offvalue = 0, height=5, \
                 width = 20)
        C2 = Checkbutton(self.scroll_2, text = "Casa André Luis", variable = self.CheckVar2, \
                 onvalue = 1, offvalue = 0, height=5, \
                 width = 20)
        C3 = Checkbutton(self.scroll_2, text = "Exército de salvação", variable = self.CheckVar3, \
                 onvalue = 1, offvalue = 0, height=5, \
                 width = 20)
        ...
        Radiobutton(self.scroll_2,text="Casa",padx = 20,pady=20,variable=self.k,value=1).grid(row=9,column=0)
        Radiobutton(self.scroll_2,text="Apartamento",padx = 20,pady=20,variable=self.k,value=2).grid(row=9,column=2)
        Radiobutton(self.scroll_2,text="Escritório",padx = 20,pady=20,variable=self.k,value=3).grid(row=9,column=3)
        ...
        Radiobutton(self.scroll_2,text="Com teto",padx = 20,pady=20,variable=self.vav,value=1).grid(row=15,column=2)
        Radiobutton(self.scroll_2,text="Sem teto",padx = 20,pady=20,variable=self.vav,value=2).grid(row=15,column=3)

        Button(self.scroll_2,text="Aplicar",command=self.Aplicar,width=25).grid(row=16,column=2)

        Button(self.scroll_2,text="Calcular",command=self.Calcular,width=30).grid(row=16,column=3)
    ...
    def getRecic(self):
        ...
        self.CheckVar1.real = self.CheckVar1.get()

        self.CheckVar2.real = self.CheckVar2.get()

        self.CheckVar3.real = self.CheckVar3.get()

        self.k.real = self.k.get()

        self.vav.real = self.vav.get()

        print(self.ndorm.real,self.npav.real,self.met.real,self.v.real,self.CheckVar1,self.CheckVar2,self.CheckVar3,self.k.real,self.vav.real)
